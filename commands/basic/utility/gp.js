...
module.exports = {
	...
	execute: async (message, args) => {
        ...
        //         if (weeklyGP >= gpGoal) {
        //             if (ranking == 1) {
        //                 return message.channel.send(`<:STAR:814075576414896148> ${memberName} has earned ${compareGP} and is the highest rank as of ${lastUpdate}! <:STAR:814075576414896148>`);
        //             }
        //             else if (ranking == 69) {
        //                 return message.channel.send(`${memberName} has earned ${compareGP} and is ranked #${ranking} as of ${lastUpdate}! <:heh:829135032106352650>`);
        //             }
        //             else if (ranking <= 10) {
        //                 return message.channel.send(`${memberName} has earned ${compareGP} and is ranked #${ranking} as of ${lastUpdate}! <:pigchamp:819862646437838858>`);
        //             }
        //             else {
        //                 return message.channel.send(`${memberName} has earned ${compareGP} and is ranked #${ranking} as of ${lastUpdate}! <:happy:814038639138308147>`);
        //             }
        //         }
        //         // Doesn't meet weekly goal, but still shows activity
        //         else if (weeklyGP < gpGoal && weeklyGP > 0) {
        //             if(flag === 'Mid') {
        //             return message.channel.send(`${memberName} has earned ${compareGP}. Only ${gpGoal - weeklyGP} left to earn before Tuesday! Currently #${ranking} as of ${lastUpdate}.`);
        //             }
        //             else {
        //             return message.channel.send(`${memberName} has earned ${compareGP} putting them ${gpGoal - weeklyGP} below the weekly target <:uganda:814038639204892682>; currently ranked #${ranking} as of ${lastUpdate}.`);
        //             }
        //         }
        //         // Member is inactive
        //         else {
        //             // eslint-disable-next-line no-lonely-if
        //             if(flag === 'Mid') {
        //             return message.channel.send(`${memberName} hasn't earned any GP as of ${lastUpdate}. Reach ${gpGoal} before Tuesday to hit our target!`);
        //             }
        //             else {
        //             return message.channel.send(`${memberName} hasn't earned any GP as of ${lastUpdate} <:wtf:814038639260205076>`);
        //             }
        //         }
        //     }
        //     else {
